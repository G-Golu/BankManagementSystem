...
namespace BankManagementSystem
{
    public partial class Employees : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update employees set name=@name, Position=@position, Salary=@salary where Doc_ID=@Doc_ID", conn);

            cmd.Parameters.AddWithValue("@Doc_ID", int.Parse(textBox1.Text));
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
            cmd.Parameters.AddWithValue("@Position", textBox3.Text);
            cmd.Parameters.AddWithValue("@salary", textBox4.Text);
